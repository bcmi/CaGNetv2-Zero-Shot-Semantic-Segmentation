...
def parse_args():
    ...
    parser.add_argument('--first_unseen', type=int, default=25, help='first several pixels are pre-set as unseen categories')
    parser.add_argument('--threshold', type=int, default=30, help='at least threshold pixels in a block should be unseen')
    parser.add_argument('--cc_max', type=int, default=12, help='maximum category count within each block')
