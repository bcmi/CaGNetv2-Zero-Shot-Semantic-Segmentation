...
class Discriminator_ps3(nn.Module):
    def __init__(self, hp):
        super(Discriminator_ps3, self).__init__()
        ...
        self.cls_3 = nn.Conv2d(hp['out_dim_fc'], hp['out_dim_fc'], 3, stride=1, padding=1)
    ...
    def forward(self, feat, mode):
        ...
        if mode == 'gan':
            ...
            cls_score = self.cls(self.cls_3(pred_map))
            return cls_score
        else:
