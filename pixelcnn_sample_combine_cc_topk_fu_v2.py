...
class Net(nn.Module):
    ...
    def forward(self, x, h=None):
        if h is not None:
            ...
            return self.conv9(self.conv3(self.conv2(self.conv1(x))))
...
outputdir = './gen2_{0}_{1}_{2}_{3}{4}'.format(config['dataset'], args.first_unseen, threshold, args.cc_max, args.suffix)
